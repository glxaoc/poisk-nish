...
# ═══════════════════════════════════════════════════════════════
# ВЕРДИКТЫ v3 (на основе NOW + YoY)
# ═══════════════════════════════════════════════════════════════

VERDICT_V3_THRESHOLDS = {
    # Пороги по объёму (now_count)
    "micro_volume": 5_000,      # < 5k = микрониша
    "medium_volume": 30_000,    # 5k-30k = средняя
    "large_volume": 100_000,    # > 100k = большая
    
    # Пороги по YoY
    "falling_yoy": -30,         # < -30% = падающий рынок
    "stable_yoy": -10,          # -10%...+10% = стабильный
    "growing_yoy": 20,          # > +20% = растущий
}
